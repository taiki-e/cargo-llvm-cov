...
// https://github.com/llvm/llvm-project/blob/llvmorg-15.0.0-rc1/llvm/tools/llvm-cov/CoverageExporterJson.cpp#L13-L47
...
pub(crate) struct File {
    ...
    ///
    /// This is None if report is summary-only.
    // https://github.com/llvm/llvm-project/blob/llvmorg-15.0.0-rc1/llvm/tools/llvm-cov/CoverageExporterJson.cpp#L93
    #[serde(skip_serializing_if = "Option::is_none")]
...
// https://github.com/llvm/llvm-project/blob/llvmorg-15.0.0-rc1/llvm/tools/llvm-cov/CoverageExporterJson.cpp#L80
#[derive(Debug, Serialize, Deserialize)]
#[cfg_attr(test, serde(deny_unknown_fields))]
...
// https://github.com/llvm/llvm-project/blob/llvmorg-15.0.0-rc1/llvm/tools/llvm-cov/CoverageExporterJson.cpp#L259
